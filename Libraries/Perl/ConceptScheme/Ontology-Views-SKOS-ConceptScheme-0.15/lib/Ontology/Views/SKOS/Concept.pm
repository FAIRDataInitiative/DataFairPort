...
{
  $Ontology::Views::SKOS::Concept::VERSION = '0.15';
}
...
=head1 SYNOPSIS
 ...
 my $concept = Ontology::Views::SKOS::Concept->new(
	label => $label,
	ontologyTermURI => $URI,
	inSchemeURI => $schemeURI,
	);

 $concept->addBroader($URI); # add skos:broader to Concept
 $concept->addNarrower($URI);  # add skos:narrower to Concept
