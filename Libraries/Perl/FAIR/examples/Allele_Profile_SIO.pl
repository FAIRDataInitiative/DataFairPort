...
my $URL = "http://biordf.org/DataFairPort/ProfileSchemas/Allele_Profile_SIO.rdf";
my $AlleleProfile = FAIR::Profile->new(
                label => 'FAIR Profile of Allele Images(SIO)',
		title => "FAIR Profile the Image portion of an Allele record", 
		description => "FAIR Profile the Image portion of an Allele record using SIO:Image classification",
